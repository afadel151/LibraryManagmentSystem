...
public class ReservationSeeder : ISeeder
{
    ...
    public async Task SeedAsync(LibraryDbContext context)
    {
        ...
        {
            new() { IdAdherent = "B/001", Cote = "MAT-001", HeureReservation = new DateTime(2026, 3, 20, 10, 0, 0) },
            new() { IdAdherent = "C/001", Cote = "LIT-001", HeureReservation = new DateTime(2026, 3, 21, 14, 30, 0) },
        };
