...
uses Unit_choix_theme, Unit1, Unit_choix_langue, Unit_choix_pays,
  ...
  Unit_choix_CDD, Unit_choix_notice_pour_MAJ;
...
procedure Tajout_these.AnnulerClick(Sender: TObject);
begin
Close ;
end;

procedure Tajout_these.Button1Click(Sender: TObject);
begin
Form_choisir_theme.Edit2.Text := '2' ;
Form_choisir_theme.ShowModal ;
end;

procedure Tajout_these.Button2Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '2' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_these.Button3Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '2' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_these.Button8Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '2' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
Form_choix_auteur.Edit_type_auteur.text := '1' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_these.Button4Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '2' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_these.Button6Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '2' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_these.Button5Click(Sender: TObject);
begin
...
procedure Tajout_these.Button7Click(Sender: TObject);
begin
...
procedure Tajout_these.Button10Click(Sender: TObject);
begin
Form_choix_mots_cles.Edit2.Text  := '2' ;
Form_choix_mots_cles.ShowModal ;
end;

procedure Tajout_these.Button9Click(Sender: TObject);
begin
...
procedure Tajout_these.Button11Click(Sender: TObject);
begin
...
procedure Tajout_these.Button12Click(Sender: TObject);
begin
Tableau_Liste_mots_cles.RowCount := 2 ;
Tableau_Liste_mots_cles.Rows[1].Clear ;
end;

procedure Tajout_these.Button13Click(Sender: TObject);
begin
...
procedure Tajout_these.Button14Click(Sender: TObject);
begin
...
procedure Tajout_these.Button15Click(Sender: TObject);
begin
Form_choisir_diplome.Edit2.Text := '2' ;
Form_choisir_diplome.Showmodal ;
end;

procedure Tajout_these.Button16Click(Sender: TObject);
begin
Form_choix_discipline.Edit2.Text := '2' ;
Form_choix_discipline.Showmodal ;
end;

procedure Tajout_these.Button17Click(Sender: TObject);
begin
Form_choix_etablissement.Edit2.Text := '2' ;
Form_choix_etablissement.Showmodal ;
end;

procedure Tajout_these.Button18Click(Sender: TObject);
begin
Form_choix_ville.Edit2.Text := '2' ;
Form_choix_ville.Showmodal ;

end;

procedure Tajout_these.BitBtn3Click(Sender: TObject);
...
ID_MENTION_RES, ID_MOT_CLE : String ;
...
if ((DBedit1.Text <> '') and (_type_operation.Text = '0')) then   //----- c'est à dire que la cote existe
        ...
        begin
                //-------------------------------------------------------------------
                //------- verifier le bon remplissage de quelques champs !!!!
                //-------------------------------------------------------------------                

                //------- Il faut que les champs diplome, etablissement et discipline soit saisis tout les trois

                if (((((( Edit19.Text = '') or ( Edit21.Text = '')) or ( Edit23.Text = '') ) or (_Cote.Text = '') ) or (Memo1.Text = '') ) or (_NBR_Exemplaire.Text = '') ) then
                        begin
                                Showmessage('Vous devez remplir Tous les champs Obligatoires : Cote, Titre Propre, Nbr Exemplaires, Diplome, Spécialité et Etablissement !!!') ;
                                goto Fin1 ;  // --- Quitter sans continuer les autres actions de la procédure
                        end;
...
//-----       sinon : on va insérer les données avec un nouveau ID_Notice
                ...
                //-----------------------------------------------------------------------------------------------------
                //------- extraire ou Affecter les identifiants pour les champs : diplome, etablissement et discipline
                //-----------------------------------------------------------------------------------------------------

                if (edit18.Text <> '') then  id_diplome := edit18.Text
                else
                        begin //---- On va essayer de chercher est ce que le  diplome existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                edit19.Text := replace_char(edit19.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "

                                Requete_Validation.active := false ;

                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := edit19.Text ;

                                DBedit1.DataField:= 'ID_DIPLOME' ;
                                Requete_Validation.SQL.Text := 'select ID_DIPLOME from DIPLOME where upper(DIPLOME) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ;

                                Showmessage (Requete_Validation.SQL.Text) ;
                                Requete_Validation.active := true ;
                                if (DBedit1.Text <> '') then //--- C'est à dire que le DIPLOME existe déjà dans la base
                                        begin
                                                id_diplome := DBedit1.Text ;
                                        end
                                else                         //--- C'est à dire que le DIPLOME n'existe pas dans la base
                                        begin
                                                //---- On va créer le DIPLOME et extraire son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'select MAX(ID_DIPLOME)  as AAA from DIPLOME' ;
                                                DBedit1.DataField := 'AAA' ;
                                                Requete_Validation.active := true ;
                                                id_diplome := inttostr( strtoint(DBedit1.Text) + 1 ) ;

                                                //---- On va inserer le DIPLOME avec son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into DIPLOME ( ID_DIPLOME , DIPLOME ) values (''' + id_diplome + ''', ''' + edit19.Text + ''')' ;
                                                DBedit1.DataField := '' ;
                                                //Showmessage (Requete_Validation.SQL.Text) ;
                ...
                if (Edit20.Text <> '') then  id_discipline := Edit20.Text
                else
                        begin //---- On va essayer de chercher est ce que la  discipline existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                Edit21.Text := replace_char(Edit21.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "

                                Requete_Validation.active := false ;
                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := Edit21.Text ;

                                DBedit1.DataField:= 'ID_DISCIPLINE' ;
                                Requete_Validation.SQL.Text := 'select ID_DISCIPLINE from DISCIPLINE where upper(DISCIPLINE) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ;
                                Requete_Validation.active := true ;
                                if (DBedit1.Text <> '') then //--- C'est à dire que la DISCIPLINE existe déjà dans la base
                                        begin
                                                id_discipline := DBedit1.Text ;
                                        end
                                else                         //--- C'est à dire que la DISCIPLINE n'existe pas dans la base
                                        begin
                                                //---- On va créer le DISCIPLINE et extraire son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'select MAX(ID_DISCIPLINE)  as AAA from DISCIPLINE' ;
                                                DBedit1.DataField := 'AAA' ;
                                                Requete_Validation.active := true ;
                                                id_discipline := inttostr( strtoint(DBedit1.Text) + 1 ) ;

                                                //---- On va inserer la DISCIPLINE avec son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into DISCIPLINE ( ID_DISCIPLINE , DISCIPLINE ) values (''' + id_discipline + ''', ''' + Edit21.Text + ''')' ;
                                                DBedit1.DataField := '' ;
                                                //Showmessage (Requete_Validation.SQL.Text) ;
                ...
                if (Edit22.Text <> '') then  id_etablissement := Edit22.Text
                else
                        begin //---- On va essayer de chercher est ce que le  etablissement existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                Edit23.Text := replace_char(Edit23.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "

                                Requete_Validation.active := false ;

                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := Edit23.Text ;

                                DBedit1.DataField:= 'ID_ETABLISSEMENT' ;
                                Requete_Validation.SQL.Text := 'select ID_ETABLISSEMENT from ETABLISSEMENT where upper(ETABLISSEMENT) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ;
                                Requete_Validation.active := true ;
                                if (DBedit1.Text <> '') then //--- C'est à dire que le ETABLISSEMENT existe déjà dans la base
                                        begin
                                                id_etablissement := DBedit1.Text ;
                                        end
                                else                         //--- C'est à dire que le ETABLISSEMENT n'existe pas dans la base
                                        begin
                                                //---- On va créer le ETABLISSEMENT et extraire son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'select MAX(ID_ETABLISSEMENT)  as AAA from ETABLISSEMENT' ;
                                                DBedit1.DataField := 'AAA' ;
                                                Requete_Validation.active := true ;
                                                id_etablissement := inttostr( strtoint(DBedit1.Text) + 1 ) ;

                                                //---- On va inserer le ETABLISSEMENT avec son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into ETABLISSEMENT ( ID_ETABLISSEMENT , ETABLISSEMENT ) values (''' + id_etablissement + ''', ''' + Edit23.Text + ''')' ;
                                                DBedit1.DataField := '' ;
                                                //Showmessage (Requete_Validation.SQL.Text) ;
...
//--------------------------- Insertion de la ville -------------------------------//
                ...
                if (_ID_Ville.Text <> '') then  id_ville := _ID_Ville.Text
                else
                        begin //---- On va essayer de chercher est ce que la VILLE existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                _Ville.Text := replace_char(_Ville.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "

                                Requete_Validation.active := false ;
                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := _Ville.Text ;
                                ...
                                if (DBedit1.Text <> '') then //--- C'est à dire que le VILLE existe déjà dans la base
                                        ...
                                        begin
                                                ...
                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into VILLE ( ID_VILLE , VILLE ) values (''' + id_ville + ''', ''' + _Ville.Text + ''')' ;
                                                DBedit1.DataField := '' ;
                                                //Showmessage (Requete_Validation.SQL.Text) ;
...
//---------------------------------------------------------------------------------//
                ...
                Requete_Validation.SQL.Text := 'insert into NOTICE ( ID_NOTICE , ID_TYPE, ID_PERIODICITE , TITRE_PROPRE, '
                                                                 ...
                                                                 + ' CDD, RESUME, NOTE_GENERALE, IS_INDEXED, ACCESSIBILITE, EXEMPLAIRE_EXISTE ) ' +
                                               'values             ('+ id_notice_actuelle + ',''2'',''99'',''' + Memo1.Text + ''','''
                                                                 ...
                                                                 +   _CDD.Text   + ''',''' + Memo5.Text + ''','''
                                                                 +   Memo4.Text  + ''',''0'',''' + accessibilite + ''',''0'')' ;
                DBedit1.DataField := '' ;
                Requete_Validation.ExecSQL ;  //*******//


                //-------------------------------------------------------------------
                //----- Inserer dans la table : "NOTICE_DIP_DIS_ETAB"
                //-------------------------------------------------------------------
                ...
                edit23.Text := replace_char(edit23.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "
                _Ville.Text := replace_char(_Ville.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "
                Edit26.Text := replace_char(Edit26.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "

                Note_Texte := Edit19.text + ';' + edit21.Text + ';' + _Ville.Text + ';' + Edit26.Text + ';' + edit23.Text + ';' ; //---- à remplir le contenu par la suite

                Requete_Validation.active := false ;
                Requete_Validation.SQL.Text := ' insert into NOTICE_DIP_DIS_ETAB ( ID_DIPLOME, ID_ETABLISSEMENT, ID_DISCIPLINE, ID_NOTICE, NOTE_TEXTE, ANNE_SOUTENANCE ) ' +
                                               ' values (''' + id_diplome + ''', ''' + id_etablissement + ''', ''' + id_discipline + ''', ''' + id_notice_actuelle + ''', ''' + Note_Texte + ''', ''' + Edit26.Text + ''') ' ;
                DBedit1.DataField := '' ;
                Requete_Validation.ExecSQL ;  //*******//
                ...
                if (_ID_Theme.Text <> '') then
                        ...
                        begin
                                //Showmessage('Le thème de la notice actuelle n''a  pas était spécifié !!!') ;
                        end;
...
if        (
        ...
        for i :=  1 to _Tableau_Pays.RowCount - 1 do
            begin
                                ...
                                _Tableau_Pays.Cells[0,i] := replace_char(_Tableau_Pays.Cells[0,i], char(39), chr(180)) ;   //--- enlever les  : " ' "
...
procedure Tajout_these.BitBtn2Click(Sender: TObject);
begin
Close;
end;

procedure Tajout_these._CoteChange(Sender: TObject);
begin
...
procedure Tajout_these.FormActivate(Sender: TObject);
var
Note_texte : TStringList ;
...
if (_type_operation.Text = '0') then   //---- Opération insertion nouvelle monographie
        ...
        begin
                ...
                //---------- Extraction du DIPLOME, DISCIPLINE, ETABLISSEMENT

                Requete_MAJ.Active := False ;
                Requete_MAJ.SQL.Text := 'select NOTE_TEXTE, ANNE_SOUTENANCE, DIP.ID_DIPLOME, DIP.DIPLOME, DISC.ID_DISCIPLINE, DISC.DISCIPLINE, ETAB.ID_ETABLISSEMENT, ETAB.ETABLISSEMENT  from NOTICE_DIP_DIS_ETAB N_D_D_E, DIPLOME DIP, DISCIPLINE DISC,  ETABLISSEMENT ETAB' +
                                        ' where N_D_D_E.id_notice = ''' + _type_operation.Text + '''' +
                                        ' and DIP.ID_DIPLOME = N_D_D_E.ID_DIPLOME ' +
                                        ' and DISC.ID_DISCIPLINE = N_D_D_E.ID_DISCIPLINE ' +
                                        ' and ETAB.ID_ETABLISSEMENT = N_D_D_E.ID_ETABLISSEMENT ' ;
                DBMemo1.DataField := '' ;
                DBEdit2.DataField := '' ;
                Requete_MAJ.Active := True ;

                DBEdit2.DataField := 'ANNE_SOUTENANCE' ;
                Edit26.Text  := DBEdit2.Text ;

                DBEdit2.DataField := 'ID_DIPLOME' ;
                Edit18.Text  := DBEdit2.Text ;
                DBEdit2.DataField := 'DIPLOME' ;
                Edit19.Text := DBEdit2.Text ;

                DBEdit2.DataField := 'ID_DISCIPLINE' ;
                Edit20.Text  := DBEdit2.Text ;
                DBEdit2.DataField := 'DISCIPLINE' ;
                Edit21.Text := DBEdit2.Text ;

                DBEdit2.DataField := 'ID_ETABLISSEMENT' ;
                Edit22.Text  := DBEdit2.Text ;
                DBEdit2.DataField := 'ETABLISSEMENT' ;
                Edit23.Text := DBEdit2.Text ;


                //--------- il faut ici récuperer la ville de la note_texte : Note_Texte[2]




                DBEdit2.DataField := 'NOTE_TEXTE' ;
                Note_Texte := Split1(';',DBEdit2.Text) ;
                _Ville.Text  := Note_Texte[2] ;
...
procedure Tajout_these.Button20Click(Sender: TObject);
begin
        Form_choisir_CDD.Edit2.Text := '2' ;
        Form_choisir_CDD.Showmodal         ;
end;

procedure Tajout_these.Button21Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '2' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_these.Button24Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '2' ;
Form_choisir_pays.ShowModal ;
...
procedure Tajout_these.Button22Click(Sender: TObject);
begin
...
procedure Tajout_these.Button23Click(Sender: TObject);
begin
_Tableau_Langue.RowCount := 2 ;
_Tableau_Langue.Rows[1].Clear ;
...
procedure Tajout_these.Button25Click(Sender: TObject);
begin
...
procedure Tajout_these.Button26Click(Sender: TObject);
begin
_Tableau_Pays.RowCount := 2 ;
_Tableau_Pays.Rows[1].Clear ;
...
procedure Tajout_these.Button19Click(Sender: TObject);
begin
...
procedure Tajout_these.BitBtn1Click(Sender: TObject);
label Fin , Fin1 , suite1, suite2, suite3, apres_Tableau_Pays, apres_Tableau_Langue , apres_Tableau_Adresse_Bibliographique;
var
i : integer ;      // --- variable utilisée pour les boucles
id_notice_actuelle, Sous_chaine_utile  : String ;
