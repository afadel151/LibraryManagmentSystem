unit ajout_resource_electronique_unit;
...
type
  ...
  Tajout_resource_electronique = class(TForm)
    ...
    Label14: TLabel;
    _TYPE_DONNEES_RESOURCE_ELEC: TEdit;
...
var
  ajout_resource_electronique: Tajout_resource_electronique ;
...
procedure Tajout_resource_electronique.AnnulerClick(Sender: TObject);
begin
Close ;
end;

procedure Tajout_resource_electronique.Button1Click(Sender: TObject);
begin
Form_choisir_theme.Edit2.Text := '6' ;
Form_choisir_theme.ShowModal ;
end;


procedure Tajout_resource_electronique.Button3Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '6' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_resource_electronique.Button8Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '6' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
Form_choix_auteur.Edit_type_auteur.text := '1' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_resource_electronique.Button4Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '6' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_resource_electronique.Button6Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '6' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_resource_electronique.Button5Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button7Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button10Click(Sender: TObject);
begin
Form_choix_mots_cles.Edit2.Text  := '6' ;
Form_choix_mots_cles.ShowModal ;
end;

procedure Tajout_resource_electronique.Button9Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button11Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button12Click(Sender: TObject);
begin
Tableau_Liste_mots_cles.RowCount := 2 ;
Tableau_Liste_mots_cles.Rows[1].Clear ;
end;

procedure Tajout_resource_electronique.Button13Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button14Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button15Click(Sender: TObject);
begin
Form_choix_collection.Edit2.Text := '6' ;
Form_choix_collection.Showmodal ;
end;

procedure Tajout_resource_electronique.Button17Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button18Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.BitBtn3Click(Sender: TObject);
...
//-----       sinon : on va insérer les données avec un nouveau ID_Notice
                ...
                Requete_Validation.SQL.Text := 'insert into NOTICE ( ID_NOTICE , ID_TYPE, ID_PERIODICITE , TITRE_PROPRE, '
                                                                 ...
                                                                 + ' CDD, NOTICE.RESUME, NOTE_GENERALE, IS_INDEXED, ACCESSIBILITE, EXEMPLAIRE_EXISTE , ISBN , TYPE_DONNEES_RESOURCE_ELEC  ) ' +
                                               'values         ('+ id_notice_actuelle + ',''6'',''99'',''' + Memo1.Text + ''','''
                                                                 ...
                                                                 +   Memo4.Text  + ''',''0'',''' + accessibilite + ''',''0'',''' +  _ISBN.Text + ''',''' + _TYPE_DONNEES_RESOURCE_ELEC.Text + ''' )' ;
                DBedit1.DataField := '' ;
...
procedure Tajout_resource_electronique.BitBtn2Click(Sender: TObject);
begin
Close;
end;

procedure Tajout_resource_electronique._CoteChange(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.FormActivate(Sender: TObject);
label etape_1 ;
begin
...
if (_type_operation.Text = '0') then   //---- Opération insertion nouvelle resource_electronique
...
else    //---- Opération de MAJ d'une resource_electronique
        ...
        begin
                ...
                DBEdit2.DataField := 'TYPE_DONNEES_RESOURCE_ELEC' ;
                _TYPE_DONNEES_RESOURCE_ELEC.Text := DBEdit2.Text ;
...
procedure Tajout_resource_electronique.Button16Click(Sender: TObject);
begin
Form_ajout_adresse_bibliographique.Edit1.Text := '6' ;
Form_ajout_adresse_bibliographique.showmodal ;
end;

procedure Tajout_resource_electronique.Button19Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button20Click(Sender: TObject);
begin
Form_choisir_CDD.Edit2.Text := '6' ; //-----
Form_choisir_CDD.Showmodal ;

end;

procedure Tajout_resource_electronique.Button24Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '6' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_resource_electronique.Button21Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '6' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_resource_electronique.Button22Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button25Click(Sender: TObject);
begin
...
procedure Tajout_resource_electronique.Button23Click(Sender: TObject);
begin
_Tableau_Langue.RowCount := 2 ;
_Tableau_Langue.Rows[1].Clear ;
...
procedure Tajout_resource_electronique.Button26Click(Sender: TObject);
begin
_Tableau_Pays.RowCount := 2 ;
_Tableau_Pays.Rows[1].Clear ;
end;
...
//----------------------------------------------------------------------------------------------------------------//
//----------------------------------------------------------------------------------------------------------------//
procedure Tajout_resource_electronique.BitBtn1Click(Sender: TObject);
label Fin , Fin1 , suite1, suite2, suite3, apres_Tableau_Pays, apres_Tableau_Langue , apres_Tableau_Adresse_Bibliographique;
var
i : integer ;      // --- variable utilisée pour les boucles
id_notice_actuelle, Sous_chaine_utile  : String ;
...
procedure Tajout_resource_electronique.Button2Click(Sender: TObject);
begin
     _ID_Collection.Text := '' ;
     _Titre_Collection.Text := '' ;
     _Sous_Titre_Collection.Text := '' ;
