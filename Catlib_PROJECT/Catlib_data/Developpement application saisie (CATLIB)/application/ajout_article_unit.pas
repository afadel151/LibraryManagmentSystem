...
procedure Tajout_Article.AnnulerClick(Sender: TObject);
begin
Close ;
end;

procedure Tajout_Article.Button1Click(Sender: TObject);
begin
Form_choisir_theme.Edit2.Text := '4' ;
Form_choisir_theme.ShowModal ;
end;

procedure Tajout_Article.Button2Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button3Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '1' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_Article.Button8Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '4' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 1 de documents ( périodique )
Form_choix_auteur.Edit_type_auteur.text := '1' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_Article.Button4Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '4' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( périodique )
Form_choix_auteur.Edit_type_auteur.text := '2' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_Article.Button6Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '4' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( périodique )
...
procedure Tajout_Article.Button5Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button7Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button10Click(Sender: TObject);
begin
Form_choix_mots_cles.Edit2.Text  := '4' ;
Form_choix_mots_cles.ShowModal ;
end;

procedure Tajout_Article.Button9Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button11Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button12Click(Sender: TObject);
begin
Tableau_Liste_mots_cles.RowCount := 2 ;
Tableau_Liste_mots_cles.Rows[1].Clear ;
end;

procedure Tajout_Article.Button13Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button14Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button15Click(Sender: TObject);
begin
Form_choix_collection.Edit2.Text := '4' ;
Form_choix_collection.Showmodal ;
end;

procedure Tajout_Article.BitBtn3Click(Sender: TObject);
...
//--------------------------------------------------------------------------------------------
                ...
                Requete_Validation.SQL.Text := 'insert into NOTICE ( ID_NOTICE , ID_SOURCE_ARTICLE , ID_TYPE, ID_PERIODICITE , TITRE_PROPRE, DATE_1ER_PUB , NUMERO_VOL,'
                                               ...
                                               'values             ('+ id_notice_actuelle + ',' + ID_SOURCE_ARTICLE + ',''4'',''99'',''' + Memo1.Text + ''',''' + _date_1_pub.Text + ''',''' + _num_vol.Text + ''','''
...
procedure Tajout_Article.BitBtn2Click(Sender: TObject);
begin
Close;
end;

procedure Tajout_Article._CoteChange(Sender: TObject);
begin
...
procedure Tajout_Article.FormActivate(Sender: TObject);
label etape_1 ;
...
procedure Tajout_Article.Button16Click(Sender: TObject);
begin
Form_ajout_adresse_bibliographique.Edit1.Text := '1' ;
Form_ajout_adresse_bibliographique.showmodal ;
end;

procedure Tajout_Article.Button19Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button20Click(Sender: TObject);
begin
Form_choisir_CDD.Edit2.Text := '4' ; //-----
Form_choisir_CDD.Showmodal ;

end;

procedure Tajout_Article.Button24Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '4' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_Article.Button21Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '4' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_Article.Button22Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button25Click(Sender: TObject);
begin
...
procedure Tajout_Article.Button23Click(Sender: TObject);
begin
_Tableau_Langue.RowCount := 2 ;
_Tableau_Langue.Rows[1].Clear ;
...
procedure Tajout_Article.Button26Click(Sender: TObject);
begin
_Tableau_Pays.RowCount := 2 ;
_Tableau_Pays.Rows[1].Clear ;
end;
...
//----------------------------------------------------------------------------------------------------------------//
//----------------------------------------------------------------------------------------------------------------//
procedure Tajout_Article.BitBtn1Click(Sender: TObject);
label Fin , Fin1 ,  suite1, suite2, suite3, apres_Tableau_Pays, apres_Tableau_Langue , apres_Tableau_Adresse_Bibliographique;
var
i : integer ;      // --- variable utilisée pour les boucles
id_notice_actuelle, Sous_chaine_utile  : String ;
