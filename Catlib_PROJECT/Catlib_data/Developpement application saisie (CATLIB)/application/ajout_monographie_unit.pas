...
uses
  ...
  Mask, DBCtrls, ADODB, OleServer, Word2000;

type
  ThackedGrid = class(TStringGrid) ;
  Tajout_monographie = class(TForm)
    ...
    Label33: TLabel;
    _Tableau_Adresse_Bibliographique: TStringGrid;
    Button16: TButton;
    Button17: TButton;
    Button18: TButton;
    Button19: TButton;
    _Mention_edition: TEdit;
    Label3: TLabel;
    ...
    chaine_Temp1: TEdit;
    Button2: TButton;
    _Tableau_Adresse_Bibliographique_Annee: TStringGrid;
    Label14: TLabel;
    Button_Afficher: TButton;
    ...
    procedure _ISBNChange(Sender: TObject);
    procedure Button_AfficherClick(Sender: TObject);
...
var
  ajout_monographie: Tajout_monographie ;
...
procedure Tajout_monographie.AnnulerClick(Sender: TObject);
begin
Close ;
end;

procedure Tajout_monographie.Button1Click(Sender: TObject);
begin
Form_choisir_theme.Edit2.Text := '3' ;
Form_choisir_theme.ShowModal ;
end;


procedure Tajout_monographie.Button3Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '3' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_monographie.Button8Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '3' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
Form_choix_auteur.Edit_type_auteur.text := '1' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_monographie.Button4Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '3' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_monographie.Button6Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '3' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( thèse )
...
procedure Tajout_monographie.Button5Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button7Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button10Click(Sender: TObject);
begin
Form_choix_mots_cles.Edit2.Text  := '3' ;
Form_choix_mots_cles.ShowModal ;
end;

procedure Tajout_monographie.Button9Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button11Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button12Click(Sender: TObject);
begin
Tableau_Liste_mots_cles.RowCount := 2 ;
Tableau_Liste_mots_cles.Rows[1].Clear ;
end;

procedure Tajout_monographie.Button13Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button14Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button15Click(Sender: TObject);
begin
Form_choix_collection.Edit2.Text := '3' ;
Form_choix_collection.Showmodal ;
end;

procedure Tajout_monographie.Button17Click(Sender: TObject);
begin

     if (_Tableau_Adresse_Bibliographique_Annee.RowCount > 2) then
                supprimer_ligne_TstringGrid(_Tableau_Adresse_Bibliographique_Annee, _Tableau_Adresse_Bibliographique.Row )
     else
                _Tableau_Adresse_Bibliographique_Annee.Rows[1].Clear ;

     if (_Tableau_Adresse_Bibliographique.RowCount > 2) then
                supprimer_ligne_TstringGrid(_Tableau_Adresse_Bibliographique, _Tableau_Adresse_Bibliographique.Row )
     else
                _Tableau_Adresse_Bibliographique.Rows[1].Clear ;


end;

procedure Tajout_monographie.Button18Click(Sender: TObject);
begin
_Tableau_Adresse_Bibliographique.RowCount := 2 ;
_Tableau_Adresse_Bibliographique.Rows[1].Clear ;

_Tableau_Adresse_Bibliographique_Annee.RowCount := 2 ;
_Tableau_Adresse_Bibliographique_Annee.Rows[1].Clear ;

end;

procedure Tajout_monographie.BitBtn3Click(Sender: TObject);
...
//---------------------------------------------------------------------------------//
                ...
                if ( ( (_Cote.Text = '') or (Memo1.Text = '') ) or (_NBR_Exemplaire.Text = '') ) then
                        begin
                                Showmessage('Vous devez remplir Tous les champs Obligatoires : Cote, Titre Propre, Nbr Exemplaires !!!') ;
                                goto Fin1 ;  // --- Quitter sans continuer les autres actions de la procédure
                        end;
...
//-----       sinon : on va insérer les données avec un nouveau ID_Notice
                ...
                Requete_Validation.active := false ;
                        ...
                        if (RadioButton1.Checked = true) then accessibilite := '1'
                        else accessibilite := '0' ;

                Requete_Validation.SQL.Text := 'insert into NOTICE ( ID_NOTICE , ID_TYPE, ID_PERIODICITE , TITRE_PROPRE, '
                                                                 + ' SOUS_TITRE, COLLATION_IMP_MATERIELLE, COLLATION_AUTRES_CAR_MAT, '
                                                                 + ' COLLATION_FORMAT, NBR_EXEMPLE, COTE, LOCALISATION , '
                                                                 + ' CDD, NOTICE.RESUME, NOTE_GENERALE, IS_INDEXED, ACCESSIBILITE, EXEMPLAIRE_EXISTE , ISBN ) ' +
                                               'values         ('+ id_notice_actuelle + ',''3'',''99'',''' + Memo1.Text + ''','''
                                                                 ...
                                                                 +   Memo4.Text  + ''',''0'',''' + accessibilite + ''',''0'',''' +  _ISBN.Text + ''')' ;
                DBedit1.DataField := '' ;
...
//***************************************************************************************************
                ...
                if ((_ID_Collection.Text <> '')) then
                 ...
                 //-------------------------------------------------------------------
                //------------- Inserer les Adresse bibliographiques
                //-------------------------------------------------------------------                

                //---- On doit parcourir le StringGrid élement par élément

if        (    (    (
                         ( _Tableau_Adresse_Bibliographique.Cells[0,1] = '' )
                         and
                         ( _Tableau_Adresse_Bibliographique.Cells[1,1] = '' )
                     )
                     and
                     ( _Tableau_Adresse_Bibliographique.Cells[2,1] = '' )
                )
                and
                ( _Tableau_Adresse_Bibliographique.Cells[3,1] = '' )
           )

           then  goto apres_Tableau_Adresse_Bibliographique ;



        for i :=  1 to _Tableau_Adresse_Bibliographique.RowCount - 1 do
            begin
                ...
                //-------------------------------------------------------------------
                //------------- Inserer la Ville (Adresse bibliographique)
                //-------------------------------------------------------------------

                if (_Tableau_Adresse_Bibliographique.Cells[0,i] <> '') then  id_ville := _Tableau_Adresse_Bibliographique.Cells[0,i]
                else
                        begin //---- On va essayer de chercher est ce que la VILLE existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                _Tableau_Adresse_Bibliographique.Cells[1,i] := replace_char(_Tableau_Adresse_Bibliographique.Cells[1,i], char(39), chr(180)) ;   //--- enlever les  : " ' "


                                Requete_Validation.active := false ;

                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := _Tableau_Adresse_Bibliographique.Cells[1,i] ;

                                DBedit1.DataField:= 'ID_VILLE' ;
                                Requete_Validation.SQL.Text := 'select ID_VILLE from VILLE where upper(VILLE) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ;
                                Requete_Validation.active := true ;
                                if (DBedit1.Text <> '') then //--- C'est à dire que le VILLE existe déjà dans la base
                                        begin
                                                id_ville := DBedit1.Text ;
                                        end
                                else                         //--- C'est à dire que le VILLE n'existe pas dans la base
                                        begin
                                                //---- On va créer le VILLE et extraire son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'select MAX(ID_VILLE) as AAA from VILLE' ;
                                                DBedit1.DataField := 'AAA' ;
                                                Requete_Validation.active := true ;
                                                id_ville := inttostr( strtoint(DBedit1.Text) + 1 ) ;

                                                //---- On va inserer le VILLE avec son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into VILLE ( ID_VILLE , VILLE ) values (''' + id_ville + ''', ''' + _Tableau_Adresse_Bibliographique.Cells[1,i] + ''')' ;
                                                DBedit1.DataField := '' ;
                                                Requete_Validation.ExecSQL ;  //*******//
                ...
                //-------------------------------------------------------------------
                //------------- Inserer l'Edition (Adresse bibliographique)
                //-------------------------------------------------------------------

                if (_Tableau_Adresse_Bibliographique.Cells[2,i] <> '') then  ID_Editeur := _Tableau_Adresse_Bibliographique.Cells[2,i]
                else
                        begin //---- On va essayer de chercher est ce que l'EDITEUR existe ou pas
                              //     s'il n'existe pas on va l'inserer

                                _Tableau_Adresse_Bibliographique.Cells[3,i] := replace_char(_Tableau_Adresse_Bibliographique.Cells[3,i], char(39), chr(180)) ;   //--- enlever les  : " ' "

                                Requete_Validation.active := false ;

                                Chaine_temp.Text := '' ;
                                Chaine_temp.Text := _Tableau_Adresse_Bibliographique.Cells[3,i] ;

                                DBedit1.DataField:= 'ID_EDITEUR' ;
                                Requete_Validation.SQL.Text := 'select ID_EDITEUR from EDITEUR where upper(EDITEUR) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ;
                                Requete_Validation.active := true ;

                                if (DBedit1.Text <> '') then //--- C'est à dire que l'Editeur existe déjà dans la base
                                        begin
                                                ID_Editeur := DBedit1.Text ;
                                        end
                                else                         //--- C'est à dire que l'Editeur  n'existe pas dans la base
                                        begin
                                                //---- On va créer l'Editeur  et extraire son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'select MAX(ID_Editeur) as AAA from EDITEUR' ;
                                                DBedit1.DataField := 'AAA' ;
                                                Requete_Validation.active := true ;
                                                ID_Editeur := inttostr( strtoint(DBedit1.Text) + 1 ) ;

                                                //---- On va inserer l'Editeur avec son identifiant

                                                Requete_Validation.active := false ;
                                                Requete_Validation.SQL.Text := 'insert into EDITEUR ( ID_EDITEUR , EDITEUR ) values (''' + ID_Editeur + ''', ''' + _Tableau_Adresse_Bibliographique.Cells[3,i] + ''')' ;
                                                DBedit1.DataField := '' ;
                                                Requete_Validation.ExecSQL ;  //*******//
                ...
                //------------- Inserer l'Edition (Adresse bibliographique)
                //-------------------------------------------------------------------
                //----- il faut tester l'existance avant d'insérer dans la table notice

                Requete_Validation.active := false ;
                Requete_Validation.SQL.Text := ' select ID_NOTICE from  NOTICE_EDITION  where ID_NOTICE = ''' + id_notice_actuelle + ''' and ID_EDITEUR =''' + ID_Editeur + ''' and ID_VILLE=''' + id_ville + '''' ;
                DBedit1.DataField := 'ID_NOTICE' ;
                Requete_Validation.active := true ;
                ...
                if (DBedit1.Text = '') then
                        begin
                              Requete_Validation.active := false ;
                              Requete_Validation.SQL.Text := ' insert into NOTICE_EDITION ( ID_NOTICE, ID_EDITEUR, ID_VILLE, DATE_EDITION ) ' +
                                               ' values (''' + id_notice_actuelle + ''', ''' + ID_Editeur + ''', ''' + id_ville + ''', ''' + _Tableau_Adresse_Bibliographique_Annee.Cells[0,i] + ''')' ;
                              DBedit1.DataField := '' ;
                              //Showmessage (Requete_Validation.SQL.Text) ;
        ...
        for i :=  1 to Tableau_Liste_mots_cles.RowCount - 1 do
            begin
                              ...
                              //     s'il n'existe pas on va l'inserer
                                ...
                                Requete_Validation.SQL.Text := 'select ID_MOT_CLE from MOTS_CLES where upper(MOT_CLE) = ''' + strupper(Pchar(Chaine_temp.Text)) + '''' ; //---- c'est à dire que le prénom n'a pas été cité
                                Requete_Validation.active := true ;
...
procedure Tajout_monographie.BitBtn2Click(Sender: TObject);
begin
Close;
end;

procedure Tajout_monographie._CoteChange(Sender: TObject);
begin
...
procedure Tajout_monographie.FormActivate(Sender: TObject);
label etape_1 ;
begin
...
if (_type_operation.Text = '0') then   //---- Opération insertion nouvelle monographie
...
else    //---- Opération de MAJ d'une monographie
        ...
        begin
                ...
                DBEdit2.DataField := 'ISBN' ;
                _ISBN.Text := DBEdit2.Text ;

                DBEdit2.DataField := 'CDD';
                _CDD.Text := DBEdit2.Text ;

                DBEdit2.DataField := 'ACCESSIBILITE' ;
                ...
                //---------- Extraction des Adresses bibliographiques

                Requete_MAJ.Active := False ;
                Requete_MAJ.SQL.Text := 'select V.ID_VILLE, V.VILLE, E.ID_EDITEUR, E.EDITEUR, N_E.DATE_EDITION from NOTICE_EDITION N_E, EDITEUR E , VILLE V ' +
                                        ' where N_E.id_notice = ''' + _type_operation.Text + '''' +
                                        ' and N_E.ID_VILLE = V.ID_VILLE ' +
                                        ' and N_E.ID_EDITEUR = E.ID_EDITEUR ' ;
                DBMemo1.DataField := '' ;
                DBEdit2.DataField := '' ;
                Requete_MAJ.Active := True ;
                Requete_MAJ.First ;
                ...
                while (not(Requete_MAJ.Eof)) do
                        begin
                             ...
                             if (_Tableau_Adresse_Bibliographique.Cells[1,1] = '') then  //--- c'est le premier co_auteur
                                begin

                                     DBEdit2.DataField := 'ID_VILLE' ;
                                     _Tableau_Adresse_Bibliographique.Cells[0,1] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'VILLE' ;
                                     _Tableau_Adresse_Bibliographique.Cells[1,1] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'ID_EDITEUR' ;
                                     _Tableau_Adresse_Bibliographique.Cells[2,1] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'EDITEUR' ;
                                     _Tableau_Adresse_Bibliographique.Cells[3,1] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'DATE_EDITION' ;
                                     _Tableau_Adresse_Bibliographique_Annee.Cells[0,1] := DBEdit2.Text ;
                                end
                             else
                                begin   //--- le reste des co_auteurs

                                     DBEdit2.DataField := 'ID_VILLE' ;
                                     _Tableau_Adresse_Bibliographique.Cells[0,_Tableau_Adresse_Bibliographique.RowCount] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'VILLE' ;
                                     _Tableau_Adresse_Bibliographique.Cells[1,_Tableau_Adresse_Bibliographique.RowCount] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'ID_EDITEUR' ;
                                     _Tableau_Adresse_Bibliographique.Cells[2,_Tableau_Adresse_Bibliographique.RowCount] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'EDITEUR' ;
                                     _Tableau_Adresse_Bibliographique.Cells[3,_Tableau_Adresse_Bibliographique.RowCount] := DBEdit2.Text ;
                                     DBEdit2.DataField := 'DATE_EDITION' ;
                                     _Tableau_Adresse_Bibliographique_Annee.Cells[0,_Tableau_Adresse_Bibliographique_Annee.RowCount] := DBEdit2.Text ;

                                     _Tableau_Adresse_Bibliographique.RowCount := _Tableau_Adresse_Bibliographique.RowCount + 1 ;
                                     _Tableau_Adresse_Bibliographique_Annee.RowCount := _Tableau_Adresse_Bibliographique_Annee.RowCount + 1 ;
...
_Tableau_Adresse_Bibliographique.Cells[0,0] := 'ID_Ville' ;
_Tableau_Adresse_Bibliographique.Cells[1,0] := 'Ville' ;
_Tableau_Adresse_Bibliographique.Cells[2,0] := 'ID_Editeur' ;
_Tableau_Adresse_Bibliographique.Cells[3,0] := 'Editeur' ;
//_Tableau_Adresse_Bibliographique.Cells[4,0] := 'Année' ;
_Tableau_Adresse_Bibliographique_Annee.Cells[0,0] := 'Année' ;
...
procedure Tajout_monographie.Button16Click(Sender: TObject);
begin
Form_ajout_adresse_bibliographique.Edit1.Text := '3' ;
Form_ajout_adresse_bibliographique.showmodal ;
end;

procedure Tajout_monographie.Button19Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button20Click(Sender: TObject);
begin
Form_choisir_CDD.Edit2.Text := '3' ; //----- 
Form_choisir_CDD.Showmodal ;

end;

procedure Tajout_monographie.Button24Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '3' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_monographie.Button21Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '3' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_monographie.Button22Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button25Click(Sender: TObject);
begin
...
procedure Tajout_monographie.Button23Click(Sender: TObject);
begin
_Tableau_Langue.RowCount := 2 ;
_Tableau_Langue.Rows[1].Clear ;
...
procedure Tajout_monographie.Button26Click(Sender: TObject);
begin
_Tableau_Pays.RowCount := 2 ;
_Tableau_Pays.Rows[1].Clear ;
end;
...
//----------------------------------------------------------------------------------------------------------------//
//----------------------------------------------------------------------------------------------------------------//
procedure Tajout_monographie.BitBtn1Click(Sender: TObject);
label Fin , Fin1 , suite1, suite2, suite3, apres_Tableau_Pays, apres_Tableau_Langue , apres_Tableau_Adresse_Bibliographique;
var
i : integer ;      // --- variable utilisée pour les boucles
id_notice_actuelle, Sous_chaine_utile  : String ;
...
procedure Tajout_monographie.Button2Click(Sender: TObject);
begin
     _ID_Collection.Text := '' ;
     _Titre_Collection.Text := '' ;
     _Sous_Titre_Collection.Text := '' ;
...
procedure Tajout_monographie._ISBNChange(Sender: TObject);
begin
//---- Cette procedure sert à verifier l'existance de l'ISBN dans la base de données

// il faut tester ici la taille saisie de l'ISBN

if ((strlen(Pchar(_ISBN.Text)) = 13) or ( strlen(Pchar(_ISBN.Text)) = 17 )) then
        begin
                DBedit1.DataField:= 'ID_NOTICE' ;
                Requete_Validation.active := false ;
                Requete_Validation.SQL.Text := 'select ID_NOTICE from notice where upper(ISBN) like ''%' + strupper(Pchar(_ISBN.Text)) + ';%''' ;
                Requete_Validation.active := true ;
                ...
                if (DBedit1.Text <> '') then
                        begin
                             label14.Caption := 'Existe !!!' ;
                             label14.Font.Color := clRed ;
                             Button_Afficher.Visible := true ;
                             _type_operation.Text := DBedit1.Text ;
                        end
        end
else
        begin
...
procedure Tajout_monographie.Button_AfficherClick(Sender: TObject);
begin

//ajout_monographie._type_operation.Text := _ISBN.Text ;
