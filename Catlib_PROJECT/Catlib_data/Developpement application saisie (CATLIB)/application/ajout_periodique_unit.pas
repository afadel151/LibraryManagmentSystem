...
var
  ajout_periodique: Tajout_periodique ;
...
procedure Tajout_periodique.AnnulerClick(Sender: TObject);
begin
Close ;
end;

procedure Tajout_periodique.Button1Click(Sender: TObject);
begin
Form_choisir_theme.Edit2.Text := '1' ;
Form_choisir_theme.ShowModal ;
end;

procedure Tajout_periodique.Button2Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button3Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '1' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_periodique.Button8Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '1' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 1 de documents ( périodique )
Form_choix_auteur.Edit_type_auteur.text := '1' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_periodique.Button4Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '1' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( périodique )
Form_choix_auteur.Edit_type_auteur.text := '2' ; //-- type d'auteur qu'on va choisir est auteur
Form_choix_auteur.ShowModal ;
end;

procedure Tajout_periodique.Button6Click(Sender: TObject);
begin
Form_choix_auteur.Edit_fenetre.text := '1' ; /// -- c'est à dire que la fenetre appellante traite le type numéro 2 de documents ( périodique )
...
procedure Tajout_periodique.Button5Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button7Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button10Click(Sender: TObject);
begin
Form_choix_mots_cles.Edit2.Text  := '1' ;
Form_choix_mots_cles.ShowModal ;
end;

procedure Tajout_periodique.Button9Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button11Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button12Click(Sender: TObject);
begin
Tableau_Liste_mots_cles.RowCount := 2 ;
Tableau_Liste_mots_cles.Rows[1].Clear ;
end;

procedure Tajout_periodique.Button13Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button14Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button15Click(Sender: TObject);
begin
Form_choix_collection.Edit2.Text := '1' ;
Form_choix_collection.Showmodal ;
end;

procedure Tajout_periodique.Button17Click(Sender: TObject);
begin

     if (_Tableau_Adresse_Bibliographique.RowCount > 2) then supprimer_ligne_TstringGrid(_Tableau_Adresse_Bibliographique, _Tableau_Adresse_Bibliographique.Row )
     else _Tableau_Adresse_Bibliographique.Rows[1].Clear ;

end;

procedure Tajout_periodique.Button18Click(Sender: TObject);
begin
_Tableau_Adresse_Bibliographique.RowCount := 2 ;
_Tableau_Adresse_Bibliographique.Rows[1].Clear ;
end;

procedure Tajout_periodique.BitBtn3Click(Sender: TObject);
...
//-----       sinon : on va insérer les données avec un nouveau ID_Notice
                ...
                Memo2.Text := replace_char(Memo2.Text, char(39), chr(180)) ;   //--- enlever les  : " ' "                                
                ...
                Requete_Validation.SQL.Text := 'insert into NOTICE ( ID_NOTICE , ID_TYPE, ID_PERIODICITE , TITRE_PROPRE, TITRE_CLE, DATE_1ER_PUB , NUMERO_VOL,'
                                               ...
                                               'values             ('+ id_notice_actuelle + ',''1'',''' +  _ID_Periodicite.Text + ''',''' + Memo1.Text + ''',''' + Memo2.Text + ''',''' + _date_1_pub.Text + ''',''' + _num_vol.Text + ''','''
                ...
                if (DBedit1.Text = '') then
                        begin
                              ...
                              Requete_Validation.SQL.Text := ' insert into NOTICE_EDITION ( ID_NOTICE, ID_EDITEUR, ID_VILLE, DATE_EDITION ) ' +
                                               ' values (''' + id_notice_actuelle + ''', ''' + ID_Editeur + ''', ''' + id_ville + ''', ''' + '' + ''')' ; // ---- Dans les periodiques, il n y a pas d'années dans l'adresse bibliographique : on  a remplacé  _Tableau_Adresse_Bibliographique.Cells[4,i] par ''
                              DBedit1.DataField := '' ;
                              //Showmessage (Requete_Validation.SQL.Text) ;
...
procedure Tajout_periodique.BitBtn2Click(Sender: TObject);
begin
Close;
end;

procedure Tajout_periodique._CoteChange(Sender: TObject);
begin
...
procedure Tajout_periodique.FormActivate(Sender: TObject);
label etape_1 ;
begin
                        ...
                        begin
                             ...
                             if (_Tableau_Adresse_Bibliographique.Cells[1,1] = '') then  //--- c'est le premier co_auteur
                                begin
                                     ...
                                     _Tableau_Adresse_Bibliographique.Cells[4,1] := DBEdit2.Text ;
                                end
                             else
                                begin   //--- le reste des co_auteurs
                                     ...
                                     DBEdit2.DataField := 'DATE_EDITION' ;
                                     _Tableau_Adresse_Bibliographique.Cells[4,_Tableau_Adresse_Bibliographique.RowCount] := DBEdit2.Text ;
...
procedure Tajout_periodique.Button16Click(Sender: TObject);
begin
Form_ajout_adresse_bibliographique.Edit1.Text := '1' ;
Form_ajout_adresse_bibliographique.showmodal ;
end;

procedure Tajout_periodique.Button19Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button20Click(Sender: TObject);
begin
Form_choisir_CDD.Edit2.Text := '1' ; //-----
Form_choisir_CDD.Showmodal ;

end;

procedure Tajout_periodique.Button24Click(Sender: TObject);
begin
Form_choisir_pays.Edit2.Text := '1' ;
Form_choisir_pays.ShowModal ;
end;

procedure Tajout_periodique.Button21Click(Sender: TObject);
begin
Form_choisir_langue.Edit2.Text := '1' ;
Form_choisir_langue.ShowModal ;
end;

procedure Tajout_periodique.Button22Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button25Click(Sender: TObject);
begin
...
procedure Tajout_periodique.Button23Click(Sender: TObject);
begin
_Tableau_Langue.RowCount := 2 ;
_Tableau_Langue.Rows[1].Clear ;
...
procedure Tajout_periodique.Button26Click(Sender: TObject);
begin
_Tableau_Pays.RowCount := 2 ;
_Tableau_Pays.Rows[1].Clear ;
end;
...
//----------------------------------------------------------------------------------------------------------------//
//----------------------------------------------------------------------------------------------------------------//
procedure Tajout_periodique.BitBtn1Click(Sender: TObject);
label Fin , Fin1 , suite1, suite2, suite3, apres_Tableau_Pays, apres_Tableau_Langue , apres_Tableau_Adresse_Bibliographique;
var
i : integer ;      // --- variable utilisée pour les boucles
id_notice_actuelle, Sous_chaine_utile  : String ;
